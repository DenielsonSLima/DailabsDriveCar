-- Migration: Contabilização de Outros Créditos no Lucro Líquido do Caixa/DRE
-- Data: 2026-06-09
...
BEGIN
    ...
    -- 9.1. Outros Créditos Efetivos (Recebidos no período)
    ...
    RETURN jsonb_build_object(
        ...
        -- O Lucro Mensal agora soma os descontos obtidos e subtrai descontos concedidos, e soma outros créditos recebidos
