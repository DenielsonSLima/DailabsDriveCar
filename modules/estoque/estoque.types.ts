...
export const VeiculoSocioSchema = z.object({
  ...
  porcentagem: z.coerce.number().min(0).max(100).default(0)
});
...
export const VeiculoSchema = z.object({
  ...
  ano_fabricacao: z.coerce.number().int().min(1900),
  ano_modelo: z.coerce.number().int().min(1900),
  combustivel: z.string().optional().nullable(),
  transmissao: z.string().optional().nullable(),
  motorizacao: z.string().optional().nullable(),
  portas: z.coerce.number().int().min(0).optional().nullable(),
  valor_custo: z.coerce.number().min(0).default(0),
  valor_custo_servicos: z.coerce.number().min(0).default(0),
  valor_venda: z.coerce.number().min(0).default(0),
  valor_promocional: z.coerce.number().min(0).optional().nullable(),
  valor_total_investido: z.coerce.number().min(0).optional(),
  valor_lucro_estimado: z.coerce.number().min(0).optional(),
  valor_margem_estimada: z.coerce.number().min(0).optional(),
