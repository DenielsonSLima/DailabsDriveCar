...
const FormCardIdentification: React.FC<Props> = ({ formData, onChange }) => {
  ...
  const { data: montadoras = [], isLoading: isLoadingMontadoras } = useQuery({
    ...
    staleTime: 1000 * 60 * 30, // 30 minutos (quase estático)
  });
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <div className="relative">
          ...
          <select
            ...
            className="w-full bg-white border border-slate-200 rounded-2xl px-5 py-4 text-sm font-bold text-[#111827] outline-none focus:ring-2 focus:ring-indigo-500 appearance-none transition-all disabled:bg-slate-50"
          ...
          {isLoadingMontadoras && (
            <div className="absolute right-12 top-[3.25rem] w-4 h-4 border-2 border-indigo-600 border-t-transparent rounded-full animate-spin"></div>
          )}
        </div>
        ...
        <div className="relative">
          ...
          <select
            ...
            className="w-full bg-white border border-slate-200 rounded-2xl px-5 py-4 text-sm font-bold text-[#111827] outline-none focus:ring-2 focus:ring-indigo-500 disabled:opacity-50 appearance-none transition-all"
          >
        ...
        <div className="relative">
          ...
          <select
            ...
            className="w-full bg-white border border-slate-200 rounded-2xl px-5 py-4 text-sm font-bold outline-none focus:ring-2 focus:ring-indigo-500 disabled:opacity-50 appearance-none text-indigo-600"
          >
          ...
          {isLoadingVersoes && (
            <div className="absolute right-4 top-[3.25rem] w-4 h-4 border-2 border-indigo-600 border-t-transparent rounded-full animate-spin"></div>
          )}
        </div>
      </div>
